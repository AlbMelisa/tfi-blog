...
export default function NuevoPostForm({ action }) {
  ...
  return isExpanded ? (
    ...
    <button
      ...
      className="w-full rounded-2xl border-dashed border-2 border-gray-200 bg-white p-4 text-left transition-all hover:bg-gray-50"
    >
